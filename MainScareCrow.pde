...
String[] questions
= {"Which of these cities is not in America?", "Question 2", "Question 3"};
String[] q1Answers = {"Boston", "Chicago", "Ottowa", "Miami"};
...
void update() {
  switch(gameState) {
    ...
    case STATE_QUESTION_SCREEN: 
      ...
      QuestionUI.setQuestions(q1Answers[0],q1Answers[1],q1Answers[2],q1Answers[3]);
      ...
      if(QuestionUI.getOverride()){
        ...
        if(down && QuestionUI.getButtonState().equals(q1Answers[0])) 
        ...
        else if(QuestionUI.getButtonState().equals(q1Answers[1])) 
        ...
        else if(QuestionUI.getButtonState().equals(q1Answers[2])) 
        ...
        else if(up && QuestionUI.getButtonState().equals(q1Answers[3])) 
        {
           QuestionUI.changeState_STATE_C_HIGHLIGHTED();
        }
        else if(click) {
